...
| `dynamic` | Should component use dynamic color for different value range | `false` | boolean |
| `dynamicOptions` | Dynamic Color for different value range | `[{minimumValue: 0, color: '#ffd700'}]` | array of object |
